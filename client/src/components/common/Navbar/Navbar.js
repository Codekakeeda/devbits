...
const Navbar = () => {
  return (
    <div className='max-width header'>
      <Link to='/explore/stocks' className='logo'>
      ...
      <div className='header-right'>
        ...
        <div className='header-search-container'>
          <div className='header-searchbar'>
            ...
            <input placeholder="What are you looking for today?" className='search-input' />
          </div>
        </div>
        ...
        <Link to='/login' className='profile-wrapper cursor-point'>
